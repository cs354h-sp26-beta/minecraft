...
export const TUNDRA_LOW_BIOME = makeBiomeVariant(
  TUNDRA_BIOME,
  "tundra_low",
  2,
  5,
);
export const PLAINS_LOW_BIOME = makeBiomeVariant(
  PLAINS_BIOME,
  "plains_low",
  4,
  10,
);
export const FOREST_LOW_BIOME = makeBiomeVariant(
  FOREST_BIOME,
  "forest_low",
  8,
  16,
);
export const DESERT_LOW_BIOME = makeBiomeVariant(
  DESERT_BIOME,
  "desert_low",
  6,
  8,
);
export const HILLS_LOW_BIOME = makeBiomeVariant(
  HILLS_BIOME,
  "hills_low",
  18,
  30,
);
export const HIGHLANDS_LOW_BIOME = makeBiomeVariant(
  HIGHLANDS_BIOME,
  "highlands_low",
  24,
  46,
);
export const MOUNTAINS_LOW_BIOME = makeBiomeVariant(
  MOUNTAINS_BIOME,
  "mountains_low",
  28,
  62,
...
export const MOUNTAINS_HIGH_BIOME = makeBiomeVariant(
  MOUNTAINS_BIOME,
  "mountains_high",
  34,
  74,
);
export const HIGHLANDS_HIGH_BIOME = makeBiomeVariant(
  HIGHLANDS_BIOME,
  "highlands_high",
  30,
  54,
);
export const HILLS_HIGH_BIOME = makeBiomeVariant(
  HILLS_BIOME,
  "hills_high",
  22,
  36,
);
export const DESERT_HIGH_BIOME = makeBiomeVariant(
  DESERT_BIOME,
  "desert_high",
  10,
  10,
);
export const FOREST_HIGH_BIOME = makeBiomeVariant(
  FOREST_BIOME,
  "forest_high",
  14,
  22,
);
export const PLAINS_HIGH_BIOME = makeBiomeVariant(
  PLAINS_BIOME,
  "plains_high",
  8,
  12,
);
export const TUNDRA_HIGH_BIOME = makeBiomeVariant(
  TUNDRA_BIOME,
  "tundra_high",
  5,
  7,
